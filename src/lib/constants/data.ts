...
export const NAV_LINKS: NavLink[] = [
  { id: "home", label: "Home", href: "#hero", sectionId: "hero" },
  { id: "about-me", label: "About me", href: "#about", sectionId: "about" },
  { id: "projects", label: "projects", href: "#projects", sectionId: "projects" },
  { id: "what-you-get", label: "What you get", href: "#overview", sectionId: "overview" },
  { id: "services", label: "Services", href: "#services", sectionId: "services" },
  { id: "clients", label: "clients", href: "#testimonial", sectionId: "testimonial" },
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "Lilipad",
    tags: ["CMS", "GSAP", "SEO"],
    href: "https://www.lilipadlibrary.org/",
    image: "/heynesh-assets/cdn.prod.website-files.com/691d7c9f14d0280ebe2d4108/693a07b45d5bf5df6ed763ff_Frame-20116046247.avif",
  ...
  },
  {
    ...
    title: "Omicron",
    tags: ["Webflow", "Motion"],
    href: "https://omicronblockchain.com/",
    image: "/heynesh-assets/cdn.prod.website-files.com/691d7c9f14d0280ebe2d4108/693a07b4c7536983db8aa94b_Frame-20116046243.avif",
    description: "Omicron is a blockchain studio helping Web 3.0 players turn ideas into decentralized products.",
  },
  {
    id: "puck",
    title: "Puck",
    tags: ["Components", "CMS", "GSAP"],
    href: "https://www.careerpuck.com/",
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    id: "testimonial-5",
    quote: "A developer with a <br/>true product mindset.",
    text: "Nenad is a rare blend of speed, quality, and collaboration. He actively contributes ideas that improve how designs translate into development, and he approaches every build with a product mindset. He’s reliable, detail-oriented, and consistently delivers high-quality work on tight timelines.",
    author: "Chrissy Cowdrey",
    role: "Product/Web Designer",
    company: "",
    avatar: "/heynesh-assets/cdn.prod.website-files.com/691d7c9f14d0280ebe2d4108/694ea7dac698cc34d76e4278_Chrissy.avif",
  },
  {
    id: "testimonial-6",
    quote: "A proven <br/>expert you trust.",
    text: "I’ve been working with Nenad for years and have always been impressed by his work ethic, fast turnaround, and attention to detail. Nenad clearly knows his craft, takes a thoughtful and disciplined approach to his work, and consistently delivers results that meet a high professional standard.",
    author: "Marko Ilic",
    role: "Founder",
    company: "see.design",
    companyHref: "https://see.design/",
  ...
  },
  {
    ...
    text: "We loved working with Nenad on the Autorank website. He showed exceptional leadership throughout the project, taking full ownership of the website infrastructure and guiding key technical decisions. His structured approach and attention to quality ensured a reliable and scalable outcome.",
    author: "Bart-Jan Leyts",
    role: "CEO",
    company: "Autorank.com",
    companyHref: "https://www.autorank.com/",
