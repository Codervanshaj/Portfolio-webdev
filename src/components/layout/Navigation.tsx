        ...
        <div className="nav-menu-wrap">
          <nav className="nav-menu">
            {NAV_LINKS.map((link, idx) => {
              const isLinkActive = activeSection !== "hero" && activeSection === link.sectionId;
              return (
                <div
                  className={`nav-menu-item ${isLinkActive ? "is-active" : ""}`}
                  key={link.id}
                ...
                >
                  <a
                    ...
                    className={`nav-link w-inline-block ${isLinkActive ? "w--current" : ""}`}
                    data-tl-desktop=""
                  ...
                  {/* Text link */}
                  <a className={`hero-navigation-link ${isLinkActive ? "w--current" : "is-text-link"}`} data-button-hover="" data-link-id={link.id} href={link.href} style={{ overflow: "hidden", pointerEvents: "auto" }}>
